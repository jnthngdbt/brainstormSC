...
% $Id: crc_eeg_readHeaderBrainP.m 436 2012-04-06 15:26:17Z christophe $
...
for ii=1:header.NumberOfChannels
    ...
    if length(pcomma)<3
        ...
        CUnit{ii} = file{ii+p1stChan}((pcomma(3)+1):end);
...
header.info.comment = strvcat(file{(pComment+2):end});
