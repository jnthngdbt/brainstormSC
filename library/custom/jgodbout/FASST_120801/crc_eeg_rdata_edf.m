...
% There are calls to readedf.m, which is distributed under the
% GNU-license, and was modified to accomodate data file with different 
% sampling rates per channel (+ a few more fixes).
%
% Note:
% - data are assumed continuous.
% - data format is assumed int16.
% - all channels are assumed to have same sampling rate.
%
...
% $Id: crc_eeg_rdata_edf.m 404 2011-10-07 15:34:55Z christophe $
...
D = meeg(D);
D.info = struct('version',header.version,'PID',header.PID, ...
