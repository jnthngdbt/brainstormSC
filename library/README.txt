...
1. Make sure to have the latest version of Brainstorm installed (installed and in Matlab path)

. To install, download the toolbox from Brainstorm website. In the folder, there is a file (matlab function) named "brainstorm.m". Open it and run it in Matlab. It will install automatically (no need to add paths manually).
