...
% $Id: crc_par.m 323 2011-03-14 10:29:36Z christophe $
...
for ifile = 1:size(files,1)
    ...
    switch bcgmethod
        ...
        case 'mcica' % constrained ICA based correction method, but data are NOT
            % corrected! Only the correction matrices are, then up to
            % the user to manually pick the "best" one via the display GUI.
