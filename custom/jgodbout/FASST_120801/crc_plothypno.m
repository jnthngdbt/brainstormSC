...
% $Id: crc_plothypno.m 463 2012-08-01 10:12:47Z christophe $
...
vect = [-10/windowsize:1/windowsize:9/windowsize];
...
if isfield(handles,'slider1')
    ...
    handles.cursor=plot(pos,8,'v','Color',[0.2 0.2 0.2],'LineWidth',2.5);
    hold off
end
