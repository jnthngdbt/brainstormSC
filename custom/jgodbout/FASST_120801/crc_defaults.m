...
% $Id: crc_defaults.m 457 2012-06-22 15:25:02Z christophe $
...
crc_def.scales.eeg   = 10^-5; % in V
crc_def.scales.eog   = 10^-5; % in V
crc_def.scales.ecg   = 3*10^-4; % in V
crc_def.scales.emg   = 10^-5; % in V
crc_def.scales.other   = 10; % in µV
